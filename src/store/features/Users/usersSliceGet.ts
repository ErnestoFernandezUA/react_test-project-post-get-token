...
// = (state: RootState) => state.usersGet.statusUpLoading === 'loading';

export const selectUsersErrorGet = (state: RootState) => state.usersGet.errorMessageGet;
// export const selectUsersErrorPost = (state: RootState) => state.usersGet.errorMessagePost;
// export const selectPostFails = (state: RootState) => state.usersGet.validationFails;
// export const selectIsUserErrorPost
// = (state: RootState) => state.usersGet.statusUpLoading === 'failed';
